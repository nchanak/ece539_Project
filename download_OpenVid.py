...
def download_files(output_directory, zip_number):
    ...
    for i in range(zip_number, zip_number):
...
if __name__ == '__main__':
    ...
    parser.add_argument('--output_directory', type=str, help='Path to the dataset directory', default="./videos")
